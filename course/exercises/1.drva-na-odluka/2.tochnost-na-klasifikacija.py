"""Точност на класификација Problem 4 (1 / 4)
...
if __name__ == "__main__":
    ...
    train_data1 = train_data[:int(len(train_data)*0.5)]
    train_data2 = train_data[int(len(train_data)*0.5):]
    ...
    brojac2=0
    for i in test_data:
        klasa1 = classify(i, t1)
        klasa2 = classify(i, t2)
        ...
        if k2 == i[-1]:
            brojac2+=1
    tochnost1 = brojac1/len(test_data)
    tochnost2 = brojac2/len(test_data)
    print("Tochnost na drvoto 1: " +str(tochnost1))
    print("Tochnost na drvoto 2: " +str(tochnost2))
    if tochnost1==tochnost2:
        print("Drvata imaat ista tochnost")
    elif tochnost1>tochnost2:
        print("Drvoto 1 e podobro od drvoto 2")
    elif tochnost2>tochnost1:
