...
вториот е индексот на сличниот текст со Пеарсонова корелација.
Во првата линија се однесува за најсличните текстови, а четвртата за текстовите кои се 4-ти по сличност со дадениот текст.
На крај во петтата линија да се испечати дали пронајдените текстови според двете метрики се исти или не (True/False).
"""
