...
Притоа, за наоѓање на сличност да се користи Пирсонова корелација и косинусно растојание.
Потребно е да се најдат наслични документи според намален вокабулар.
Намалениот вокабулар се добива со отстранување на 100те зборови што се појавуваат најчесто во множеството.

Помош: целосниот вокабулар може да го добиете со моменталната имплементација на функцијата get_words,
додека за добивање на намалениот вокабулар потребна е функција со која ќе се игнорираат претходно пресметаните 100 најпојавувани зборови.
Зборовите потребно е да бидат сортирани алфабетски, по што треба да се сортираат според бројот на појавувања.
